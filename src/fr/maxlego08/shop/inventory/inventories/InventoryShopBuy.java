...
public class InventoryShopBuy extends VInventory {
	...
	public boolean openInventory(ZShop main, Player player, int page, Object... args) throws Exception {
		...
		addItem(ConfigBuyInventory.maxItemintSlot,
				new ItemButton(Lang.maxItemButton.getInitButton("%max%", String.valueOf(item.getMaxStackSize()))).setClick(event -> {
		...
		addItem(ConfigBuyInventory.buyintSlotSlot, new ItemButton(Lang.buyButton.getInitButton()));
