...
public enum Message {
	...
	COMMAND_SYNTAXE_ERROR("§cVous devez ex§cuter la commande comme ceci§7: §a%s"),
	COMMAND_NO_PERMISSION("§cVous n'avez pas la permission d'ex§cuter cette commande."),
	COMMAND_NO_CONSOLE("§cSeul un joueur peut ex§cuter cette commande."),
