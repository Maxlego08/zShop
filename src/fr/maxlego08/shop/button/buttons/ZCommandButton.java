...
public class ZCommandButton extends ZItemButton implements CommandButton {
	...
	public ZCommandButton(ButtonType type, ItemStack itemStack, int slot, String permission, String message,
			...
			List<String> commands, int maxStack, List<String> lore, boolean isPermanent) {
		super(type, itemStack, slot, permission, message, elseButton, iEconomy, sellPrice, buyPrice, economy, maxStack, lore, isPermanent);
